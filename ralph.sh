...
3. Проверь что типы проходят: npm run typecheck
4. Проверь что тесты проходят: npm test
5. Обнови статус задачи в tasks.json на "done".
6. Добавь запись в progress.md с датой и ID задачи.
7. Сделай git commit.
