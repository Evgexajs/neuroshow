 ...
 * @param {string} showId - The show ID to connect to
 */
 ...
 * @param {Object} event - The ShowEvent object
 */
function addEventToFeed(event) {
  ...
  eventEl.dataset.sequenceNumber = event.sequenceNumber;
 ...
 * @param {string} channel - The channel type (PUBLIC, PRIVATE, ZONE)
